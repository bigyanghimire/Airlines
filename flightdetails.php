                    ...
                    <?php
                        ...
                        if($result){
                            if (isset($_POST['submit'])){
                                ...
                                $sql = "SELECT * FROM aircrafts WHERE aircraft_no LIKE '%$searched_key%' or capacity LIKE '%$searched_key%' or mfdby LIKE '%$searched_key%' or mfdon LIKE '%$searched_key%' order by ac_id DESC";
                                $result = mysqli_query($con,$sql);
                            if ($result){
                                $i = 1;
